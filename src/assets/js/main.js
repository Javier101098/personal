...
$(function() {
  ...
  var bar = new ProgressBar.Line(express, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3200,
  ...
  var bar = new ProgressBar.Line(mongo, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3200,
  ...
  var bar = new ProgressBar.Line(angular, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3200,
  ...
  var bar = new ProgressBar.Line(ionic, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3200,
  ...
  var bar = new ProgressBar.Line(typescript, {
    strokeWidth: 1.72,
    easing: 'easeInOut',
    duration: 1400,
    delay: 3200,
